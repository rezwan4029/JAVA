  ...
  public static void main(String[] args) {
    ...
    for (int cs = 1; cs <= T; cs++) {
      ...
      for (int i = 0; i < intervals.size(); i++) {
        System.out.println(String.format("Profit %d : %s", i + 1, intervals.get(i)));
      }
...
class Interval {
  ...
  public String toString() {
    return String.format("(buy at = %d & sold at = %s)", buy, sell);
  }
}
...
Output:
  ...
  Profit 1 : (buy at = 0 & sold at = 3)
  Profit 2 : (buy at = 4 & sold at = 6)
